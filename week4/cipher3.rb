...
class Cipher
  ...
  def encrypt(message)
    ...
    message_pairs.each do |pair|
      ...
      if row_0 == row_1
        encrypted_message += col_0 < 5 ? @cifer_square[row_0][col_0 + 1] : @cifer_square[row_0][0]
        encrypted_message += col_1 < 5 ? @cifer_square[row_0][col_1 + 1] : @cifer_square[row_0][0]
      elsif col_0 == col_1
        encrypted_message += row_0 < 5 ? @cifer_square[row_0 + 1][col_0] : @cifer_square[0][col_0]
        encrypted_message += row_1 < 5 ? @cifer_square[row_1 + 1][col_0] : @cifer_square[0][col_0]
      else
...
puts c.encrypt('HI DE TH EG OL DI NT HE TR EX ES TU MP')